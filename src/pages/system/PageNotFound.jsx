    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center h-screen bg-neutral-950 text-white text-center px-4">
        {!imageError ? (
          ...
          <div className="text-9xl font-bold text-tv-accent mb-8">404</div>
        )}
        ...
        <Link
          to="/"
          className="bg-tv-accent text-white px-6 py-3 rounded-lg hover:bg-tv-accent-hover transition-colors focus-visible:outline-tv-accent"
        >
