  ...
  return (
    <nav className="bg-black text-white py-4 px-6 shadow-lg transition-shadow">
      <div className="flex items-center justify-between">
        ...
        <ul
          className="md:flex space-x-4 items-center md:flex-row transition-all duration-300 ease-in-out hidden md:block"
        >
          <li>
            <Link
              to="/"
      ...
      {menuOpen && (
        <div className="md:hidden absolute left-0 right-0 top-full bg-black text-white py-4 px-6 mt-4">
